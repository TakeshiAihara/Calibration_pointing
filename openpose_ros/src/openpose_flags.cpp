...
// OpenPose
DEFINE_string(model_folder,             "/home/apu_wrs/openpose/models/",      "Folder path (absolute or relative) where the models (pose, face, ...) are located.");
...
DEFINE_string(output_resolution,        "640x480",        "The image resolution (display and output). Use \"-1x-1\" to force the program to use the"
                                                        " input image resolution.");
                                        //realsensed435:848x480  hsr:640x480
DEFINE_int32(num_gpu,                   -1,             "The number of GPU devices to use. If negative, it will use all the available GPUs in your"
                                                        " machine.");
DEFINE_int32(num_gpu_start,             0,              "GPU device start number.");
DEFINE_int32(keypoint_scale,            2,              "Scaling of the (x,y) coordinates of the final pose data array, i.e., the scale of the (x,y)"
...
DEFINE_string(hand_net_resolution,      "368x368",      "Multiples of 16 and squared. Analogous to `net_resolution` but applied to the hand keypoint"
                                                        " detector.");
DEFINE_int32(hand_scale_number,         6,              "Analogous to `scale_number` but applied to the hand keypoint detector. Our best results"
