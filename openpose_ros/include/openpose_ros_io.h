...
namespace openpose_ros {
    ...
    class OpenPoseROSIO
    {
        private:
            ...
            ros::Publisher poses_pub_Nose;
            ros::Publisher poses_pub_LEye;
            ros::Publisher poses_pub_RElbow;
            ros::Publisher poses_pub_RWrist;
            ros::Publisher poses_pub_Fingertip;
            ros::Publisher poses_pub_First_joint;
            ros::Publisher poses_pub_Second_joint;
            ros::Publisher poses_pub_Third_joint;
